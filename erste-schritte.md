...
1. Klicken Sie links neben der Überschrift **Listen** auf **Neue Liste**.
2. Vergeben Sie einen klaren Namen, zum Beispiel `Projekt Relaunch`, `Support Eingang` oder `Team Backoffice`, und bestätigen Sie mit **Anlegen**.
3. Ergänzen Sie bei Bedarf eine Farbe, Standardansicht und Sortierung.
4. Fügen Sie die ersten Aufgaben hinzu.
